...
Prefeitura RS Farroupilha: NFS-e (Nota Fiscal Eletrônica de Serviços) segue a LGPD (Lei nº 13.709/2018).
...
Acessar, corrigir, eliminar, portar, revogar consentimento. Contato: [pref_rs_farroupilha_nfs@mcp.ai](mailto:pref_rs_farroupilha_nfs@mcp.ai). Reclamações: [ANPD](https://www.gov.br/anpd/pt-br).
